defmodule Indexer.Block.Fetcher do
  ...
  @receipts_batch_size Application.get_env(:indexer, :receipt_fetcher_block_batch_size)
  @receipts_concurrency Application.get_env(:indexer, :receipt_fetcher_concurrency)
