defmodule Indexer.Block.Catchup.Fetcher do
  ...
  @blocks_batch_size Application.get_env(:indexer, :catchup_fetcher_block_batch_size)
  @blocks_concurrency Application.get_env(:indexer, :catchup_fetcher_concurrency)
